...
namespace McSntt.Helpers
{
    public class DbSeedData
    {
        public static void CreateSeedData(bool useMockData = false)
        {
            ...
            var events = new[]
                         {
                             ...
                             new Event
                             {
                                 Created = true,
                                 Description =
                                     "Der er fest klokken 23:00. Klæd jer ud som forskellige bådtyper! Det bliver både sjovt og hyggeligt!",
                             ...
                             new Event
                             {
                                 Created = true,
                                 Description =
                                     "Generalforsamling i Klubhuset med valg af ny formand og godkendelse af budget.",
                             ...
                             new Event
                             {
                                 Created = true,
                                 Description =
                                     "Der er åbent hus med brød og pølser samt øl og vand til medlemmer og gæster",
            ...
            var logbooks = new[]
                           {
                               new Logbook
                               {
                                   ...
                                   AnswerFromBoatChief =
                                       "Der bliver udbedret i løbet af en uge, båden er stadig operationel",
            ...
            #region Save data
            IBoatDal boatDal = (useMockData ? new BoatMockDal(true) : DalLocator.BoatDal);
            IEventDal eventDal = (useMockData ? new EventMockDal(true) : DalLocator.EventDal);
            ILectureDal lectureDal = (useMockData ? new LectureMockDal(true) : DalLocator.LectureDal);
            ILogbookDal logbookDal = (useMockData ? new LogbookMockDal(true) : DalLocator.LogbookDal);
            IPersonDal personDal = (useMockData ? new PersonMockDal(true) : DalLocator.PersonDal);
            IRegularTripDal tripDal = (useMockData ? new RegularTripMockDal(true) : DalLocator.RegularTripDal);
            ISailClubMemberDal scmDal = (useMockData ? new SailClubMemberMockDal(true) : DalLocator.SailClubMemberDal);
            IStudentMemberDal smDal = (useMockData ? new StudentMemberMockDal(true) : DalLocator.StudentMemberDal);
            ITeamDal teamDal = (useMockData ? new TeamMockDal(true) : DalLocator.TeamDal);
